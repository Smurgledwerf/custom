...
def main(server=None, input=None):
    ...
    try:
        ...
        if 'WORK_ORDER' in lookup_code:
            ...
            #print "WO CURRENT COST = %s" % current_cost
            ...
            new_cost = current_cost - wh_cost
            server.update(work_order.get('__search_key__'), {'actual_cost': new_cost})
        ...
        #print "UNCostify Work Hours END code = %s" % code
