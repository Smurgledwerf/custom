        ...
        behavior = {'css_class': 'clickme', 'type': 'click_up', 'cbjs_action': '''        
                        try{
                           ...
                           if(inform.value != '' && inform.value != null){
                               ...
                               note_ccs = 'scheduling@2gdigital.com;matt.misenhimer@2gdigital.com';
